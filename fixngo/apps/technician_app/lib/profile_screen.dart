          ...
          : SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        TextButton(
                          onPressed: () => Navigator.pushNamed(context, '/documents_kyc'),
                  ...
                  _menuItem(Icons.document_scanner_rounded, 'Documents & KYC', () => Navigator.pushNamed(context, '/documents_kyc')),
                  ...
                  _menuItem(Icons.calendar_month_rounded, 'Schedule', () => Navigator.pushNamed(context, '/schedule')),
                  _menuItem(Icons.history_rounded, 'Activity History', () => Navigator.pushNamed(context, '/activity_history')),
                  _menuItem(Icons.bar_chart_rounded, 'Reports & Analytics', () => Navigator.pushNamed(context, '/reports')),
                  _menuItem(Icons.settings_rounded, 'Settings', () => Navigator.pushNamed(context, '/settings')),
                  const SizedBox(height: 16),
                  const SectionLabel('Support'),
                  _menuItem(Icons.help_rounded, 'Help & Support', () => Navigator.pushNamed(context, '/support')),
                  _menuItem(Icons.policy_rounded, 'Privacy Policy', () => Navigator.pushNamed(context, '/privacy_policy')),
